...
# Here compute ROHF energy using Psi4
scf_e, wfn = psi4.energy('SCF', return_wfn=True)

# Grab data including Beta from
Ca = wfn.Ca() # take care! the new Ca is C
Cb = wfn.Cb() # Beta orbitals
...
t = time.time()
# check paper in readme 
MO = np.asarray(mints.mo_spin_eri(Ca, Cb)) # (C1 = C, C2 = C)
